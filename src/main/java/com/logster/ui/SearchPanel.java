...
public class SearchPanel extends IconTabPanel {
    ...
    private final JTextField locationTextBox = new JTextField( "C:\\Users\\vivek\\Developer\\groovy-language-server",30);
    ...
    private final JTextField searchBox = new JTextField("groovy",30);
